...
void BoardRenderer::render()
{
   ...
   AllegroFlare::Vec2D start_tile_connecting_edge =
      Tracko::PieceRenderer::get_connecting_coords(start_tile_start_connecting_position);
   //float start_tile_entrance_x = start_tile_coordinates.x * column- 
   //float start_tile_entrance_y = start_tile_coordinates
   //al_draw_circle(start_tile_entrance_x, start_tile_entrance_y
