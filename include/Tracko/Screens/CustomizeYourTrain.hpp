...
namespace Tracko
{
   namespace Screens
   {
      class CustomizeYourTrain : public AllegroFlare::Screens::Base
      {
      public:
         static constexpr char* TYPE = (char*)"Tracko/Screens/CustomizeYourTrain";
      ...
      private:
         ...
         std::function<void(Tracko::Screens::CustomizeYourTrain*, void*)> on_menu_choice_callback_func;
      ...
      public:
         CustomizeYourTrain(AllegroFlare::EventEmitter* event_emitter=nullptr, AllegroFlare::BitmapBin* bitmap_bin=nullptr, AllegroFlare::FontBin* font_bin=nullptr);
         virtual ~CustomizeYourTrain();

         void set_on_menu_choice_callback_func(std::function<void(Tracko::Screens::CustomizeYourTrain*, void*)> on_menu_choice_callback_func);
         void set_on_menu_choice_callback_func_user_data(void* on_menu_choice_callback_func_user_data);
         std::function<void(Tracko::Screens::CustomizeYourTrain*, void*)> get_on_menu_choice_callback_func() const;
