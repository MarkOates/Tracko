...
namespace Tracko
{
   ...
   public:
      ...
      static Tracko::Board* create_board(int num_columns=6, int num_rows=4, AllegroFlare::Int2D start_coordinate={ 0, 2 }, Tracko::Piece::ConnectingPosition start_connecting_position=Tracko::Piece::ConnectingPosition::CONNECTING_POSITION_LEFT, AllegroFlare::Int2D end_coordinate={ 5, 1 }, Tracko::Piece::ConnectingPosition end_connecting_position=Tracko::Piece::ConnectingPosition::CONNECTING_POSITION_RIGHT, int seed=0);
   };
}
