...
#include <Tracko/Elements/CustomizeYourTrain.hpp>
...
class Tracko_Elements_CustomizeYourTrainTest : public ::testing::Test {};
class Tracko_Elements_CustomizeYourTrainWithAllegroRenderingFixtureTest : public AllegroFlare::Testing::WithAllegroRenderingFixture {};


TEST_F(Tracko_Elements_CustomizeYourTrainTest, can_be_created_without_blowing_up)
{
   Tracko::Elements::CustomizeYourTrain level_select;
}


TEST_F(Tracko_Elements_CustomizeYourTrainTest, DISABLED__TODOs)
{
...
TEST_F(Tracko_Elements_CustomizeYourTrainWithAllegroRenderingFixtureTest, render__does_not_blow_up)
{
   AllegroFlare::EventEmitter event_emitter;
   Tracko::Elements::CustomizeYourTrain level_select(&event_emitter, &get_font_bin_ref());
   level_select.render();
}


TEST_F(Tracko_Elements_CustomizeYourTrainWithAllegroRenderingFixtureTest,
   CAPTURE__render__displays_the_level_select_window)
{
   ...
   Tracko::Elements::CustomizeYourTrain level_select(&event_emitter, &get_font_bin_ref(), levels_list);
...
// an Tracko/Elements/SelectionCursorBox object
//TEST_F(Tracko_Elements_CustomizeYourTrainWithAllegroRenderingFixtureTest,
...
TEST_F(Tracko_Elements_CustomizeYourTrainTest, move_cursor_left__wraps_the_cursor_when_at_the_edge)
{
   Tracko::Elements::CustomizeYourTrain level_select;
...
TEST_F(Tracko_Elements_CustomizeYourTrainTest,
